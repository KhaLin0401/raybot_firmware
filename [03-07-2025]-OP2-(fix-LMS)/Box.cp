#line 1 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
...
#line 1 "d:/mikroc pro for dspic/include/string.h"
#line 20 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
Box_Object Box_t;
#line 27 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
uint8_t Box_KeyTouchStatus(Box_Object* box) {
 if (box ==  ((void *)0) ) return 0;
...
#line 44 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
void Box_LimitSwitchStatus(Box_Object* box) {
...
#line 76 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
void Box_UpdateStatus(Box_Object* box) {
...
#line 105 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
uint8_t Box_IsObjectDetected(Box_Object* box) {
 if (box ==  ((void *)0) ) return 0;
 return box->object_detected;
}
#line 115 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
Box_state Box_GetStatus(Box_Object* box) {
 if (box ==  ((void *)0) ) return INACTIVE;
 return box->box_status;
}
#line 125 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
float Box_GetDistance(Box_Object* box) {
 if (box ==  ((void *)0) ) return 0.0f;
 return box->distance_inbox;
}
#line 135 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
uint8_t Box_GetLimitSwitchState(Box_Object* box) {
 if (box ==  ((void *)0) ) return 0;
 return box->limit_switch_state;
}
#line 145 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
void Box_SetDetectionThreshold(Box_Object* box, float threshold) {
 if (box ==  ((void *)0) ) return;
 if (threshold > 0) {
 box->detection_threshold = threshold;
...
#line 157 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
float Box_GetDetectionThreshold(Box_Object* box) {
 if (box ==  ((void *)0) ) return 0.0f;
 return box->detection_threshold;
}
#line 167 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
void Box_GetDetailedStatus(Box_Object* box, char* status_info) {
#line 181 "C:/Users/ASUS/Desktop/RAYBOT/SOURCE/raybot_firmware/[03-07-2025]-OP2-(fix-LMS)/Box.c"
}
