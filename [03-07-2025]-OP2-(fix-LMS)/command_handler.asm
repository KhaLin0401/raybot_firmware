...
;command_handler.c,249 :: 		(uint8_t)_bmsData._sumSOC, (int)_bmsData._errorCount, (int)1, (int)1);
	...
	MOV.B	W0, [W14+12]
;command_handler.c,248 :: 		(int)_bmsData._cellVoltages0, (int)_bmsData._cellVoltages1, (int)_bmsData._cellVoltages2, (int)_bmsData._cellVoltages3,
	MOV	__bmsData+28, W0
	MOV	__bmsData+30, W1
	CALL	__Float2Longint
	MOV	W0, [W14+10]
...
;command_handler.c,679 :: 		if (JSON_GetInt(dataParser, "type", &type)){
	...
	MOV	W0, W12
	MOV	W11, W10
	MOV	#lo_addr(?lstr_106_command_handler), W11
	CALL	_JSON_GetInt
	POP	W10
	POP	W12
	CP0	W0
...
;command_handler.c,681 :: 		sprintf(handler->response_buffer, ">{\"type\":4,\"id\":\"%s\",\"dev_id\":\"pic\"}\r\n", id);
	...
	ADD	W10, W0, W1
	PUSH	W12
	MOV	#lo_addr(?lstr_107_command_handler), W0
	PUSH	W0
	PUSH	W1
	CALL	_sprintf
	SUB	#6, W15
