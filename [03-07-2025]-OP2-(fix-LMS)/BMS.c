...
uint8_t BMS_Update(void) {
    ...
    switch (_bmsState) {
        case BMS_STATE_IDLE:
            ...
            return 0; /* Chưa hoàn thành, tiếp tục gọi */
        ...
        case BMS_STATE_WAIT_RESPONSE:
            /* Kiểm tra timeout hoặc đủ frame */
        ...
        case BMS_STATE_PROCESS_DATA:
            ...
            _bmsState = BMS_STATE_IDLE;
            return success; /* Hoàn thành lệnh hiện tại */
        ...
        case BMS_STATE_ERROR:
            ...
            _bmsState = BMS_STATE_IDLE;
            return 0; /* Lỗi, tiếp tục gọi */
    }

    return 0; /* Mặc định: chưa hoàn thành */
}
